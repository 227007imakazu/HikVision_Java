package com.demo.hicvision.NetSDKDemo;
...
//    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary("E:\\ningXia\\verification_system\\check\\ningroad-check\\src\\main\\resources\\hikvision\\HCNetSDK.dll", HCNetSDK.class);
